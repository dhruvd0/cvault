                                ...
                                Container(
                                  decoration: BoxDecoration(
                                    color: userType == UserTypes.customer
                                        ...
                                        :userType == UserTypes.dealer? const Color(0xff70755F):const Color(0xff0EE7AD),
                                    border: Border.all(
                                      width: 0.5, 
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                      ...
                                                      color:userType == UserTypes.customer? Color.fromARGB(255, 239, 179, 89):Color(0xff566749),
